...
namespace template
{
    class TexturedPlane : Primitive
    {
        ...
        public float d;
        public TexturedPlane(Vector3 p1p2, Vector3 p1p3, Vector3 normal, float d, Vector3 colour, string texture, float glass = 0.0f, float reflective = 0.0f) : base(colour, glass, reflective)
        {
            this.p1p2 = p1p2;
            this.p1p3 = p1p3;
            this.normal = normal;
